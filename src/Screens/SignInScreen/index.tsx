...
const SignInScreen = ({ navigation }) => {
  ...
  return (
    <CustomView style={{ gap: 16, backgroundColor: theme.colors.surface }} className="flex flex-col justify-center h-full p-4">
      ...
      <CustomInput id="password" label="Password" placeholder="Enter Password" secureTextEntry />
      <CustomButton onPress={() => navigation.navigate('Chat')}>Submit</CustomButton>
      <Divider />
